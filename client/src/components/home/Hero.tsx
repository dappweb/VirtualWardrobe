      ...
      <div className="relative">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8 xl:mt-20">
              <div className="text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-bold text-neutral-900 sm:text-5xl md:text-6xl">
                  <span className="block font-display">{t('home.hero.title')}</span>
                  <span className="block text-accent-500 font-display mt-1">{t('home.hero.subtitle')}</span>
                </h1>
                <p className="mt-3 text-base text-neutral-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto lg:mx-0">
                  {t('home.hero.description', 'A revolutionary platform that bridges the gap between physical fashion and digital assets. Discover, collect, and own exclusive pieces from the world\'s most innovative fashion designers.')}
                </p>
        ...
        <div className="hidden lg:block absolute right-0 inset-y-0 pointer-events-none">
          <img 
            ...
            alt={t('home.hero.imageAlt', 'Fashion design abstract')} 
