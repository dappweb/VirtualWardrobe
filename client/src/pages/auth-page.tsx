...
function Web3LoginButton({ walletType }: Web3LoginButtonProps) {
  const { connect, login, isConnected, address, isLoading } = useWeb3Auth();
  ...
  return (
    ...
    >
      ...
      {walletType === 'ethereum' ? 'MetaMask' : 'TronLink'}
    </Button>
  );
}
                ...
                <TabsContent value="login" className="py-4">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                      <Web3LoginButton walletType="ethereum" />
                      <Web3LoginButton walletType="tron" />
                    </div>
                  </div>
                </TabsContent>
